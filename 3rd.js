...
let asiaregion = countries.forEach(countries => {
        console.log ("countries",countries.name,"region",countries.region,"population",countries.population,"subregion",countries.subregion)
    })
